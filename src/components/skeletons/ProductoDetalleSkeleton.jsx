...
export default function ProductoDetalleSkeleton({ animate = true }) {
  ...
  return (
    <div className="flex h-full min-h-0 w-full flex-col overflow-hidden bg-neutral-100">
      <div className="app-scroll-y flex min-h-0 flex-1 flex-col pb-[calc(7rem+env(safe-area-inset-bottom))]">
        {/* Hero imagen */}
      ...
      <footer className="fixed inset-x-0 bottom-0 z-30">
        <div className="flex w-full justify-center p-3 pb-[max(0.75rem,env(safe-area-inset-bottom))]">
